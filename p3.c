...
for(i=0;i<10;i++)
{
/* int msgrcv(int msg, struct msgbuf * buf, int size, long type, int flag): recupera el
primer
mensaje con identificador type, de tamaño size almacenado en la cola con identificador
msg,
en el segundo campo de buf. El último parámetro sirve para controlar el nivel de
ocupación de
la cola */
